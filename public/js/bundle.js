...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"deactivate.js":[function(require,module,exports) {
"use strict";
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            result = _context.sent;
            (0, _alerts.showAlert)('success', 'Account is Deactivated');
            (0, _login.logout)(); // if (result.data.status === 'success') {
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js","./login":"login.js"}],"signup.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (result.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Check your email to verify the account.');
              window.setTimeout(function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "http://127.0.0.1:8080/api/v1/users/accountConfirm/".concat(token)
            });
          ...
          case 3:
            ...
            if (result.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Account is verified');
              window.setTimeout(function () {
                location.assign('/');
              }, 1000);
            }
...
var resetPassword = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(resetToken, password, passwordConfirm) {
    var result;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://127.0.0.1:8080/api/v1/users/resetPassword/".concat(resetToken),
              data: {
                password: password,
                passwordConfirm: passwordConfirm
              }
          ...
          case 3:
            ...
            if (result.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'New Password is Set');
              window.setTimeout(function () {
                location.assign('/');
              }, 2500);
            }
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51H1x30Dg9d6yaN3KTO1Qmhug4XBa3S5lWaqL3KGyA9Mv22Aqyqi599tKc9JAS25SJotpVIc6GGQixpUL34ihGdET00JJFzWeQB');
            _context.prev = 1;
            _context.next = 4;
            return (0, _axios.default)({
              method: 'GET',
...
if (deactivateBtn) {
  deactivateBtn.addEventListener('click', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              e.target.style.cursor = 'not-allowed';
              _context6.next = 5;
              return (0, _deactivate.deactivate)();
        ...
        while (1) {
          switch (_context9.prev = _context9.next) {
            case 0:
              ...
              e.submitter.disabled = true;
              e.submitter.style.cursor = 'not-allowed';
              resetToken = document.getElementById('token-reset').value;
              password = document.getElementById('password-reset').value;
              passwordConfirm = document.getElementById('password-confirm-reset').value;
              console.log(resetToken);
              console.log(password);
              console.log(passwordConfirm);
              _context9.next = 12;
              return (0, _resetPassword.resetPassword)(resetToken, password, passwordConfirm);
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "3024" + '/');
